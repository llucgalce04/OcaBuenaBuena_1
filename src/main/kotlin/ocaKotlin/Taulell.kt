...
class Taulell  {
    // creem las casella final
    private val casFinal = 63
    // creem la llist on guardarem les casselles
    val casillas: ArrayList<Casella> = arrayListOf()



    init {
        // creem las casellas buides
        for (i in 0 until casFinal) {
            casillas.add(Casella("OcaKotlin.Casella$i"))
        }
        // creem las casellas especials
        ...
        casillas[18] = Casella("Posada", 0, 5)
